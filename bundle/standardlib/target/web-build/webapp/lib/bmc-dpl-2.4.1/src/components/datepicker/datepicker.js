...
angular.module("d-datepicker-templates", []).run(["$templateCache", function ($templateCache) {
    ...
    $templateCache.put("uib/template/datepicker/popup.html",
        "<ul dropdown-nested ng-if=\"isOpen\" class=\"d-datepicker-popup\" style=\"display: block\" ng-style=\"{top: position.top+'px', left: position.left+'px'}\" ng-keydown=\"keydown($event)\" ng-click=\"$event.stopPropagation()\">\n" +
        "	<li ng-transclude></li>\n" +
