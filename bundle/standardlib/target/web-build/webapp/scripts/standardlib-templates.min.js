angular.module('com.bmc.arsys.rx.standardlib.utils').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('scripts/view-components/record-editor/field-components/character-field/character-field.directive.html',
    ...
    "                            && rxConfiguration.enableMultiSelection\n" +
    "                            && !isPasswordField\" multiple=\"true\" template-url=\"scripts/view-components/record-editor/field-components/character-field/character-field-multiselect.view.html\" ng-model=\"multiSelectModel.value\" ng-change=\"onMultiSelectChange(multiSelectModel.value)\" options=\"option.value as option.label for option in selectOptions\"></am-multiselect></label></div></div></div>"
  );


  $templateCache.put('scripts/view-components/record-editor/field-components/date-field/date-field-design.directive.html',
    "<div ng-show=\"!rxConfiguration.hidden\" class=\"d-textfield\" ng-class=\"{'d-textfield_required': fieldDefinition.fieldOption == 'REQUIRED'}\"><label class=\"d-textfield__label\"><span class=\"d-textfield__item\">{{fieldDefinition.label}}</span><p class=\"input-group\"><input type=\"text\" ng-disabled=\"true\" class=\"d-textfield__input\"> <span class=\"input-group-btn\"><button type=\"button\" class=\"btn btn-default\"><i class=\"d-icon-calendar\"></i></button></span></p></label></div>"
  );


  $templateCache.put('scripts/view-components/record-editor/field-components/date-field/date-field.directive.html',
    "<div ng-switch on=\"rxConfiguration.state\"><div ng-switch-when=\"READ\"><div ng-include=\"'scripts/view-components/record-editor/field-components/field-read.directive.html'\"></div></div><div ng-switch-when=\"EDIT\"><div ng-show=\"!rxConfiguration.hidden\" class=\"d-textfield\" ng-class=\"{'d-textfield_required': fieldDefinition.fieldOption == 'REQUIRED', 'd-textfield_invalid' : form[fieldDefinition.name].$dirty && form[fieldDefinition.name].$invalid}\"><label class=\"d-textfield__label\"><span class=\"d-textfield__item\">{{rxConfiguration.label}}</span><p class=\"input-group\"><input type=\"text\" name=\"{{fieldDefinition.name}}\" ng-disabled=\"rxConfiguration.disabled\" uib-datepicker-popup=\"yyyy-MM-dd\" datepicker-options=\"datepickerOptions\" show-button-bar=\"false\" ng-model=\"data.date\" ng-required=\"fieldDefinition.fieldOption == 'REQUIRED'\" is-open=\"data.opened\" ng-change=\"dateChanged()\" class=\"d-textfield__input\"> <span class=\"input-group-btn\"><button type=\"button\" class=\"btn btn-default\" ng-click=\"open($event)\"><i class=\"d-icon-calendar\"></i></button></span></p></label></div></div></div>"
  );


  $templateCache.put('scripts/view-components/record-editor/field-components/date-time-field/date-time-field-design.directive.html',
    "<div ng-show=\"!rxConfiguration.hidden\" class=\"d-textfield\" ng-class=\"{'d-textfield_required': fieldDefinition.fieldOption == 'REQUIRED'}\"><span class=\"d-textfield__item d-textfield__item_label\">{{fieldDefinition.label}}</span><div class=\"row\"><div class=\"col-sm-6\"><div class=\"input-group\"><input type=\"text\" ng-disabled=\"true\"> <span class=\"input-group-btn\"><button type=\"button\" class=\"btn btn-default\"><i class=\"d-icon-calendar\"></i></button></span></div></div><div class=\"col-sm-6\"><uib-timepicker ng-model=\"time\" ng-disabled=\"true\" readonly-input=\"true\" show-meridian=\"ismeridian\" class=\"d-timepicker d-timepicker__no-label\"></uib-timepicker></div></div></div>"
  );


  $templateCache.put('scripts/view-components/record-editor/field-components/date-time-field/date-time-field.directive.html',
    "<div ng-switch on=\"rxConfiguration.state\"><div ng-switch-when=\"READ\"><div ng-include=\"'scripts/view-components/record-editor/field-components/field-read.directive.html'\"></div></div><div ng-switch-when=\"EDIT\"><div ng-show=\"!rxConfiguration.hidden\" class=\"d-textfield\" ng-class=\"{'d-textfield_required': fieldDefinition.fieldOption == 'REQUIRED', 'd-textfield_invalid' : form[fieldDefinition.name].$dirty && form[fieldDefinition.name].$invalid}\"><span class=\"d-textfield__item d-textfield__item_label\">{{rxConfiguration.label}}</span><div class=\"row\"><div class=\"col-sm-6\"><div class=\"input-group\"><input type=\"text\" name=\"{{fieldDefinition.name}}\" class=\"d-textfield__input\" ng-disabled=\"rxConfiguration.disabled\" uib-datepicker-popup=\"yyyy-MM-dd\" ng-model=\"data.date\" ng-required=\"fieldDefinition.fieldOption == 'REQUIRED'\" is-open=\"data.opened\" datepicker-options=\"datepickerOptions\" show-button-bar=\"false\" ng-change=\"dateChanged()\"> <span class=\"input-group-btn\"><button type=\"button\" class=\"btn btn-default\" ng-click=\"open($event)\"><i class=\"d-icon-calendar\"></i></button></span></div></div><div class=\"col-sm-6\"><uib-timepicker ng-model=\"data.date\" ng-disabled=\"rxConfiguration.disabled\" ng-change=\"timeChanged()\" hour-step=\"hstep\" minute-step=\"mstep\" show-meridian=\"ismeridian\" class=\"d-timepicker d-timepicker__no-label\"></uib-timepicker></div></div></div></div></div>"
  );


  $templateCache.put('scripts/view-components/record-editor/field-components/decimal-field/decimal-field.directive.html',
    "<div ng-switch on=\"rxConfiguration.state\"><div ng-switch-when=\"READ\"><div ng-include=\"'scripts/view-components/record-editor/field-components/field-read.directive.html'\"></div></div><div ng-switch-when=\"EDIT\"><div ng-show=\"!rxConfiguration.hidden\" class=\"d-textfield\" ng-class=\"{'d-textfield_required': fieldDefinition.fieldOption == 'REQUIRED',\n" +
    "     'd-textfield_invalid' : form[fieldDefinition.name].$dirty && form[fieldDefinition.name].$invalid}\"><label class=\"d-textfield__label\"><span class=\"d-textfield__item\">{{rxConfiguration.label}}</span> <input name=\"{{fieldDefinition.name}}\" ng-disabled=\"rxConfiguration.disabled\" class=\"d-textfield__input\" type=\"number\" ng-model=\"fieldInstance.value\" ng-pattern=\"/^(\\-)?(\\d{1,}(\\.)?\\d*){1}$/\" rx-string-to-number ng-required=\"fieldDefinition.fieldOption == 'REQUIRED'\" aria-required=\"{{fieldDefinition.fieldOption== 'REQUIRED'}}\"></label></div></div></div>"
  );


  $templateCache.put('scripts/view-components/record-editor/field-components/field-read.directive.html',
    "<div ng-show=\"!rxConfiguration.hidden\" class=\"d-textfield\"><label class=\"d-textfield__label\"><span class=\"d-textfield__item\">{{::fieldDefinition.name}}</span></label><p>{{getFormattedValue()}}</p></div>"
  );


  $templateCache.put('scripts/view-components/record-editor/field-components/floating-field/floating-field.directive.html',
